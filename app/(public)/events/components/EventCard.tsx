  ...
  return (
    ...
    >
      ...
      >
        <div className="p-3 sm:p-4">
          ...
          <div className="grid gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <span
                className="inline-flex items-center px-2 sm:px-2.5 py-1 rounded-md text-xs font-medium
                                         bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200"
              >
                <span className="mr-1 hidden sm:inline">📅</span>
                {
                  DateTime.formatDisplay(startDate, {
                    format: "local",
        ...
        <div
          className="absolute inset-0 bg-gray-900 opacity-0 group-active:opacity-10
