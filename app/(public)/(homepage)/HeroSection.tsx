          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 w-full space-y-10 text-center lg:text-left">
              ...
              <div className="relative space-y-8">
                {/* Decorative element */}
                <div className="absolute -left-4 top-0 w-24 h-24 bg-blue-500/10 dark:bg-blue-500/20 rounded-full blur-2xl -z-10"></div>
                ...
                <div className="space-y-4">
                  ...
                  <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white">
                    ...
                    <span className="relative">
                      Become Gladiators
                      <span className="absolute -bottom-2 left-0 right-0 h-1 bg-blue-600 dark:bg-blue-400 rounded-full transform scale-x-0 animate-[expand_0.5s_ease-in-out_forwards] origin-left"></span>
                    </span>
                  </h1>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-6">
                  <Link
                    href="/trackers/individual-contest-tracker/1"
                    className="w-full sm:w-auto px-8 py-4 bg-blue-600
            ...
            <div className="flex-1 min-w-0 lg:max-w-[640px] relative group">
              ...
              <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/30 via-purple-500/30 to-pink-500/30 rounded-2xl blur-2xl opacity-20 dark:opacity-40 animate-ambient-pulse"></div>

              {/* Additional ambient highlights */}
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl blur opacity-75 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <div className="relative rounded-xl overflow-hidden shadow-2xl bg-gray-900/95 backdrop-blur-sm border border-gray-800/50">
                {/* Editor top bar */}
                <div className="flex items-center justify-between p-3 sm:p-4 bg-gray-900/90 border-b border-gray-800">
