...
import { Award, ExternalLink, Users, MapPin, Calendar, ChevronDown } from "lucide-react";
...
export default function ContestCard({ contest }: ContestCardProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
      {/* Contest Header - Now clickable */}
      <div
        onClick={() => setIsExpanded(!isExpanded)}
        className="p-8 border-b border-gray-100 dark:border-gray-700 cursor-pointer group"
      >
