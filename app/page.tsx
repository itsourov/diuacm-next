          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                DIU ACM is the hub for competitive programming excellence at
                Daffodil International University. We prepare and send teams to
                prestigious programming contests including ACM ICPC, fostering a
                community of problem solvers and algorithmic thinkers.
              </p>
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={index} className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-white dark:bg-gray-800 shadow-lg flex items-center justify-center">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="relative pl-8 pb-6">
                    <div className="absolute left-0 top-0 bottom-0 w-px bg-blue-200 dark:bg-blue-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                We don&apos;t have a traditional membership system. Your passion
                for competitive programming and regular participation makes you
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white shadow-xl">
              <div className="space-y-6">
                ...
                <p className="text-blue-100">
                  Join our Telegram channel to stay updated with contests,
